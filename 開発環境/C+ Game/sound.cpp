...
{
	{ "data\\SOUND\\BGM\\NES-Shooter.wav", -1 },	// BGM0
	{ "data\\SOUND\\BGM\\Title.wav", -1 },			// BGM1
	{ "data\\SOUND\\SE\\run.wav", 0 },				// 走り
	{ "data\\SOUND\\SE\\jump.wav", 0 },				// ジャンプ
	{ "data\\SOUND\\SE\\attack.wav", 0 },			// 攻撃
	{ "data\\SOUND\\SE\\hit.wav", 0 },				// ヒット
	{ "data\\SOUND\\SE\\enemy_ult.wav", 0 },		// 敵必殺
	{ "data\\SOUND\\SE\\enemy_hit.wav", 0 },		// 敵ヒット
	{ "data\\SOUND\\SE\\enemy_dest.wav", 0 },		// 敵撃破
...
CSound::CSound()
{
	...
	for (int nCount = 0; nCount < SOUND_LABEL_MAX; nCount++)
	{
		g_apSourceVoice[nCount] = NULL;
		g_apDataAudio[nCount] = NULL;
		g_aSizeAudio[nCount] = NULL;
	}
}
//==============================================
//デストラクタ
